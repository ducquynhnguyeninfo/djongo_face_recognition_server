"""
Django settings for djongo_face_recognition_server project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'gforcevehicle.herokuapp.com', 'http://localhost:8080']
...
ROOT_URLCONF = 'djongo_face_recognition_server.urls'
...
ASGI_APPLICATION = 'djongo_face_recognition_server.asgi.application'


WSGI_APPLICATION = 'djongo_face_recognition_server.wsgi.application'
CHANNEL_LAYERS = {
    'default': {
...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_DIR / 'face_db.sqlite3'),
    }
